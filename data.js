...
const Space = {
	...
	solarSystem: {
		...
		objects: {
			...
			triton:    { name: "Triton (Neptune's moon)",          diameter:    2707, color: "#aea5a6", type: "satellite", hasImg: true },
			...
			ceres:     { name: "Ceres (Asteroid belt's asteroid)", diameter:     946, color: "#898790", type: "asteroid",  hasImg: true },
